module.exports = {
  ...
  BIKES_DEFAULT_MAC_IOS: process.env.BIKES_DEFAULT_MAC_IOS,
  BIKES_DEFAULT_MAC_ANDROID: process.env.BIKES_DEFAULT_MAC_ANDROID,
  BIKES_DEFAULT_FIRST_HANDSHAKE: process.env.BIKES_DEFAULT_FIRST_HANDSHAKE,
  BIKES_DEFAULT_SECOND_HANDSHAKE: process.env.BIKES_DEFAULT_SECOND_HANDSHAKE,
}
